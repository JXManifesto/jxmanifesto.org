...
export const content = {
  en: {
    ...
    home: {
      eyebrow: "Versioned, open, humane",
      title: "A manifesto for better Journalist Experience.",
      intro:
        "JX [Journalist Experience] is the quality of the everyday systems, tools, rhythms, and decisions that shape how journalism is made.",
      primary: "Read the Manifesto",
      secondary: "Contribute on GitHub",
    },
    manifesto: {
      title: "The JX Manifesto",
      subtitle:
    ...
    about: {
      title: "About JX",
      body: [
        "Journalist Experience is a lens for improving the systems around journalism: editorial workflows, publishing tools, verification routines, collaboration habits, analytics, and automation.",
        "It matters because the public sees the final story, but journalists live inside the machinery that makes the story possible. When that machinery is hostile, opaque, or rushed, quality suffers.",
  ...
  fa: {
    ...
    home: {
      eyebrow: "نسخه‌مند، باز، انسانی",
      title: "بیانیه‌ای برای تجربهٔ بهتر روزنامه‌نگار.",
      intro:
        "JX یا تجربهٔ روزنامه‌نگار، کیفیت ابزارها، فرایندها، ریتم کاری و تصمیم‌هایی است که تولید روزنامه‌نگاری را شکل می‌دهد.",
      primary: "خواندن بیانیه",
      secondary: "مشارکت در گیت‌هاب",
    },
    manifesto: {
      title: "بیانیهٔ JX",
      subtitle:
        "روزنامه‌نگاری کاری عمومی است؛ شرایط انجام این کار، کیفیت چیزی را که به جامعه می‌رسد شکل می‌دهد.",
      quote: "کیفیت تحریریه از تجربهٔ کسانی که آن را می‌سازند جدا نیست.",
      license:
        "متن این بیانیه با مجوز Creative Commons Attribution 4.0 International / CC BY 4.0 منتشر می‌شود.",
      sections: [
        [
          "روزنامه‌نگاری یک تجربهٔ کاری هم هست",
          "روزنامه‌نگاری فقط خروجی منتشرشده نیست؛ فرایند یافتن، راستی‌آزمایی، ویرایش، بسته‌بندی و توضیح اطلاعات زیر فشار زمان نیز بخشی از آن است.",
        ],
        [
          "ابزارها کیفیت تحریریه را شکل می‌دهند",
          "هر فیلد در سامانهٔ انتشار، هر هشدار، داشبورد و قالب، انتخاب‌های تحریریه را جهت می‌دهد. ابزار بهتر، کار دقیق را آسان‌تر می‌کند.",
        ],
        [
          "سرعت نباید دقت را نابود کند",
          "انتشار سریع مهم است، اما سرعت مجوزی برای حذف راستی‌آزمایی، زمینه و مراقبت نیست.",
        ],
        [
          "تحریریه‌ها به گردش‌کار انسانی نیاز دارند",
          "تحریریه‌ای که فرسودگی را عادی کند، در نهایت قضاوت حرفه‌ای را تضعیف می‌کند. ریتم پایدار، نیاز تحریریه‌ای است.",
        ],
        [
          "فناوری باید در خدمت قضاوت تحریریه باشد",
          "اتوماسیون، تحلیل داده و هوش مصنوعی زمانی مفیدند که قضاوت انسانی را روشن‌تر، مستندتر و پاسخ‌گوتر کنند.",
        ],
        [
          "شفافیت، انتساب و پاسخ‌گویی مهم‌اند",
          "JX خوب، منبع‌ها، ویرایش‌ها، اصلاحیه‌ها، حقوق و مسئولیت‌ها را در زمان درست قابل‌دیدن می‌کند.",
        ],
        [
          "هوش مصنوعی باید روزنامه‌نگاران را توانمند کند، نه حذف",
          "هوش مصنوعی باید کار تکراری را کم کند، دسترسی را گسترش دهد و به راستی‌آزمایی کمک کند؛ بی‌آنکه مسئولیت و مؤلف بودن را پاک کند.",
        ],
        [
          "تحریریهٔ آینده باید باز، سنجش‌پذیر و انسانی باشد",
          "JX باید آشکارا بحث شود، مرحله‌به‌مرحله بهبود یابد و با اثرش بر انسان، فرایند و ارزش عمومی سنجیده شود.",
        ],
      ],
    },
    about: {
      title: "دربارهٔ JX",
      body: [
        "تجربهٔ روزنامه‌نگار لنزی برای بهتر کردن سامانه‌های پیرامون روزنامه‌نگاری است: گردش‌کار تحریریه، ابزار انتشار، روال‌های راستی‌آزمایی، همکاری، سنجه‌ها و اتوماسیون.",
        "این موضوع مهم است چون مخاطب محصول نهایی را می‌بیند، اما روزنامه‌نگار درون سازوکاری زندگی می‌کند که آن محصول را ممکن می‌کند. اگر این سازوکار خصمانه، مبهم یا شتاب‌زده باشد، کیفیت آسیب می‌بیند.",
        "JXManifesto.org بیانیه‌ای باز و نسخه‌مند است و باید با گفت‌وگو، ترجمه و بازنگری عمومی تکامل پیدا کند.",
      ],
    },
    contribute: {
      title: "مشارکت",
      body: [
        ...
        "بیانیه نسخه‌مند است تا خوانندگان بتوانند تغییر ایده‌ها را در طول زمان ببینند.",
      ],
      cta: "باز کردن مخزن",
    },
    licensePage: {
      title: "مجوز",
      body: [
        "متن بیانیه با مجوز CC BY 4.0 منتشر می‌شود. می‌توانید آن را بازنشر یا اقتباس کنید، حتی برای استفادهٔ تجاری، به شرط آنکه انتساب مناسب بدهید.",
...
export const principles = (locale: Locale) =>
  content[locale].manifesto.sections.map(([title, summary], index) => ({
    number: index + 1,
    title,
    summary,
  }));
